...
class UnitTestsBehavior(unittest.TestCase):
    ...
    def test_act(self):
        ...
        for _ in range(150):
            ...
            u.calculate_net_in()
            u.cycle()
            self.assertTrue(0.75 < u.act <= 0.8)

        u.add_excitatory(0.0) # u.act should drop to zero immediately.
        u.calculate_net_in()
        u.cycle()
        self.assertEqual(u.act, 0.0)
    ...
    def test_xx1_thr(self):
        ...
        self.assertTrue(1.0e-10 > u_spec.noisy_xx1(0.20) > 0.0)
